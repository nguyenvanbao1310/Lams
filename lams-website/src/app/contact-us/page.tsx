        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <div className="bg-linear-to-br from-yellow-600 to-amber-800 rounded-2xl p-8 text-white">
                <div className="mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-linear-to-r from-yellow-600 to-amber-800 text-white font-semibold py-4 px-8 rounded-lg hover:-translate-y-1 hover:shadow-xl transition-all uppercase tracking-wider"
                >
                  Send Message
                </button>
              </form>
