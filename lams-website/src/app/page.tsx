...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-amber-600 to-amber-800 text-white relative overflow-hidden">
      ...
      <section id="about-us" className="py-24 bg-white ">
        <div className="container mx-auto px-4 ">
          <div className="max-w-5xl mx-auto text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent">
              Who We Are
            </h2>
      ...
      <section
        id="programs"
        className="py-24 bg-gradient-to-br from-gray-50 to-amber-50"
      >
        <div className="container mx-auto px-4">
          <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent">
            Why Choose LAMS?
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ml-5 lg:mb-16 items-center">
            <div className="text-4xl lg:text-5xl font-bold text-center bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl group">
                ...
                />
                <div className="absolute bg-gradient-to-t from black/50 to-transparent"></div>
              </div>
            </div>
            <div className="space-y-6">
              {dataLoad?.features.map((feature: Feature, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`text-5xl bg-gradient-to-br ${feature.color} p-4 rounded-xl shadow-lg group-hover:scale-110 transition-transform`}
                    >
                      <Icon />
                    </div>
          ...
          <div className="max-w-4xl mx-auto text-center bg-white p-12 rounded-3xl shadow-xl">
            ...
            <a
              href="#programs"
              className="mt-4 inline-block bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white px-10 py-4 rounded-full transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105"
            >
              Learn More
            </a>
          </div>
      ...
      <section className="py-24 bg-white brightness-96">
        <div className="container mx-auto px-4">
            ...
            <div className="space-y-10">
              {dataLoad?.stats.map((stat: StatItem, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex items-center gap-6 p-8 bg-gradient-to-br from-amber-50 to-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 group"
                  >
                    <div className="text-6xl group-hover:scale-110 transition-transform">
                      <Icon />
                    </div>
                    <h3 className="text-5xl lg:text-6xl font-bold bg-gradient-to-r from-amber-600 to-amber-800 bg-clip-text text-transparent mb-2">
                      {stat.value}
                    </h3>
          ...
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-br from-gray-50 to-amber-50 p-12 rounded-3xl shadoww-xl">
            ...
            <a
              href="#"
              className="inline-flex items-center bg-gradient-to-r from-amber-600 to-amber-800 hover:from-amber-700 hover:to-amber-800 text-white px-10 py-4 rounded-full transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:scale-105"
            >
      ...
      <section
        id="contact-us"
        className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-amber-900 text-white relative overflow-hidden"
      >
        <div className="absolute inset-0 opacity-10">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-3xl shadow-2xl">
              <div className="flex flex-col lg:flex-row gap-4">
                <input
                  ...
                  className="grow px-6 py-4 rounded-xl bg-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-amber-500 transition-all text-lg"
                />
                <select
                  value={selectedDept}
                  onChange={(e) => setSearchQuery(e.target.value)}
                ...
                <button className="bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:cursor-pointer hover:to-amber-800 px-10 py-4 rounded-xl transition-all duration-300 font-bold text-lg shadow-lg hover:shadow-xl whitespace-nowrap hover:scale-105">
                  Find Program
                </button>
              </div>
            </div>
